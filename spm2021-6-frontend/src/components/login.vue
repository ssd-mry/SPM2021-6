        ...
        <el-container class="login">
          <el-header class="header">
            <el-menu
              ...
              mode="horizontal"
              router>
              <el-menu-item index="0" @click="goTo('/')">管理员登录</el-menu-item>
              <el-menu-item index="1" @click="goTo('/login_Administrator')">ROOT用户登录</el-menu-item>
            </el-menu>
          </el-header>
          <el-main class="view">
            <router-view id="login_view"></router-view>
